...
enum PacketType {
	...
	LISTING_RESULT   = 0x06,
	RELOADING_REQUEST = 0x0E,
	RELOADING_RESULT = 0x0F,
	...
	SERVER_RELOADING_REQUEST = BROADCAST_TYPE | RELOADING_REQUEST,
	SERVER_RELOADING_RESULT  = BROADCAST_TYPE | RELOADING_RESULT
};
